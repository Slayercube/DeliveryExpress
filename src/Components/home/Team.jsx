...
const Team = () => {
  return (
    <div>
      <section>
        {/* Container */}
        <div className="mx-auto w-full max-w-7xl px-5 py-16 md:px-10 md:py-20 mt-3" id={styles.team}>
          {/* Title */}
          <h2 className="text-center text-3xl font-bold md:text-5xl">
            Our Team Members
          </h2>
          <p className="mx-auto mb-8 mt-4 text-center text-sm text-gray-500 sm:text-base md:mb-12 lg:mb-16">
            Founders of Delivery Express, since 2009.
          </p>
          {/* Content */}
          <div className="grid grid-cols-1 justify-items-center gap-5 sm:grid-cols-2 sm:justify-items-stretch md:grid-cols-3 md:gap-4 lg:gap-6">
            ...
            {/* Item */}
            <div className="mx-auto flex w-full flex-col items-center gap-4 py-8 text-center md:px-8 md:py-4 lg:px-12" id={styles.teamsaeed}>
              <img
            ...
            {/* Item */}
            <div className="mx-auto flex w-full flex-col items-center gap-4 py-8 text-center md:px-8 md:py-4 lg:px-12" id={styles.teamjaouu}>
              <img
            ...
            {/* Item */}
            <div className="mx-auto flex w-full flex-col items-center gap-4 py-8 text-center md:px-8 md:py-4 lg:px-12" id={styles.teamsidhu}>
              <img
